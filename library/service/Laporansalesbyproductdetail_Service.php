...
class Laporansalesbyproductdetail_Service
{
  ...
  public function getlistsales()
  {
    ...
    try {
      $query = "SELECT sub_salecentral.kode_barang, liquid.nama_barang, sub_salecentral.harga_jual, sub_salecentral.qty, salecentral.tgl_invoice, sub_salecentral.sub_total, customer.nama_customer, sub_salecentral.no_invoice, salecentral.keterangan FROM sub_salecentral INNER JOIN liquid ON sub_salecentral.kode_barang = liquid.kode_barang INNER JOIN salecentral ON sub_salecentral.no_invoice = salecentral.no_invoice INNER JOIN customer ON salecentral.kode_customer = customer.kode_customer";
      $result = $db->fetchAll($query);
      $query2 = "SELECT sub_salecentral.kode_barang, accessories.nama_aksesoris AS nama_barang, sub_salecentral.harga_jual, sub_salecentral.qty, salecentral.tgl_invoice, sub_salecentral.sub_total, customer.nama_customer, sub_salecentral.no_invoice, salecentral.keterangan FROM sub_salecentral INNER JOIN accessories ON sub_salecentral.kode_barang = accessories.kode_aksesoris INNER JOIN salecentral ON sub_salecentral.no_invoice = salecentral.no_invoice INNER JOIN customer ON salecentral.kode_customer = customer.kode_customer";
      $result2 = $db->fetchAll($query2);
      $query3 = "SELECT sub_salecentral.kode_barang, atomizer.nama_atomizer AS nama_barang, sub_salecentral.harga_jual, sub_salecentral.qty, salecentral.tgl_invoice, sub_salecentral.sub_total, customer.nama_customer, sub_salecentral.no_invoice, salecentral.keterangan FROM sub_salecentral INNER JOIN atomizer ON sub_salecentral.kode_barang = atomizer.kode_atomizer INNER JOIN salecentral ON sub_salecentral.no_invoice = salecentral.no_invoice INNER JOIN customer ON salecentral.kode_customer = customer.kode_customer";
