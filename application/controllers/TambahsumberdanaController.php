...
require_once 'service/Tambahsumberdana_Service.php';

class TambahsumberdanaController extends Zend_Controller_Action {

    public function init() {
    $registry = Zend_Registry::getInstance();
    $this->auth = Zend_Auth::getInstance();
    $this->Home_Service = Home_Service::getInstance();
	$this->Tambahsumberdana_Service = Tambahsumberdana_Service::getInstance();
    ...
    public function indexAction() {
		$sessionlogin = new Zend_Session_Namespace('sessionlogin');
		$this->view->permission = $sessionlogin->permission;
        $this->_helper->layout->setLayout('tambahsumberdana-layout');
		$this->view->Tambahsumberdana_Service = $this->Tambahsumberdana_Service;
		$this->view->data = $this->Tambahsumberdana_Service->getlistliquid();
		$this->view->menu = $this->Tambahsumberdana_Service->getmenu();
		$this->view->seq  = $this->Tambahsumberdana_Service->getNoSeq();
    }
	...
	public function tambahdataAction() {
		...
		$this->view->supplier=$this->Tambahsumberdana_Service->getSupplier();
		$this->view->rasa=$this->Tambahsumberdana_Service->getRasa();
		$this->view->seq=$this->Tambahsumberdana_Service->getNoSeq();
    }
	...
	public function kirimdataAction() { 
		...
		$data = array(
						...
						'nama_akun' => $nama_akun,
					  	...
					  	'type' => $type,
					   	'nama_cabang_pembuka' => $nama_cabang_pembuka); 
		if($action == 'tambah'){
			$this->view->datainsert=$this->Tambahsumberdana_Service->insertdata($data);
		} else {
			$this->view->datainsert=$this->Tambahsumberdana_Service->editdata($data);
		}
   ...
   public function hapusdataAction(){
		...
		$hasil = $this->Tambahsumberdana_Service->hapusData($dataInput);
	...
	public function editdataAction() {
		...
		$this->view->data=$this->Tambahsumberdana_Service->getDataLiquid($id);
	...
	public function cekseqAction(){
		...
		$this->view->id_id_volume = $this->Tambahsumberdana_Service->getSeq($id_id_volume);
	}
